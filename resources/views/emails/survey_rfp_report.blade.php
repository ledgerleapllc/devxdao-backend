            ...
            <tr style="vertical-align: top;" valign="top">
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                    ...
                    <div style="background-color:#722ed1;">
                        <div class="block-grid " style="min-width: 320px; max-width: 80%; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: transparent;">
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#722ed1;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:800px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
                                <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color:transparent;width:800px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->
                                <div class="col num12" style="min-width: 320px; max-width: 80%; display: table-cell; vertical-align: top; width: 800px;">
                                            ...
                                            <div style="color:#393d47;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:50px;padding-right:20px;padding-bottom:15px;padding-left:20px;">
                                                <div class="txtTinyMce-wrapper" style="line-height: 1.2; font-size: 12px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; color: #393d47; mso-line-height-alt: 14px;">
                                                    <div style="font-size: 14px; line-height: 1.2; word-break: break-word; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 17px; margin: 0; padding-bottom: 5px;">
                                                        <b>Rank of bids</b><br>
                                                        <table class="table" style="width: 100%; text-align: left; margin: 20px 0;">
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                @foreach ($survey->surveyRfpRanks as $rank)
                                                                @php
                                                                $rankStr = \App\Http\Helper::getOrderString($rank->rank);
                                                                @endphp
                                                                @if($rank->surveyRfpBid && $rank->is_winner == 1)
                                                                <tr>
                                                                    <td> {{ $rank->rank }} </td>
                                                                    <td> {{ $rank->bid }} </td>
                                                                    <td> {{ $rank->surveyRfpBid->forum }} </td>
                                                                    <td> €{{ $rank->surveyRfpBid->amount_of_bid }} </td>
                                                                    <td> {{Carbon\Carbon::parse($rank->surveyRfpBid->delivery_date)->format('d-m-Y H:i A')}} </td>
                                                                </tr>
                                                                @endif
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    @for($i = 1; $i <= $survey->number_response; $i++) 
                                                                        @php
                                                                            $rankStr = \App\Http\Helper::getOrderString($i);
                                                                        @endphp
                                                                        <th><strong> {{$rankStr}} place </strong></th>
                                                                    @endfor
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 5%;"> {{ $bid->bid }} </td>
                                                                    <td > {{ $bid->forum }} </td>
                                                                    <td> €{{ $bid->amount_of_bid }} </td>
                                                                    <td> {{Carbon\Carbon::parse($bid->delivery_date)->format('d-m-Y H:i A')}} </td>
                                                                    <td> {{ $bid->total_vote }} </td>
                                                                    @for($i = 1; $i <= $survey->number_response; $i++)
                                                                        @php
                                                                        $key = $i . "_place";
                                                                        @endphp
                                                                        <th><strong> {{$bid->$key}} </strong></th>
                                                                        @endfor
                                                                </tr>
                                                                @endforeach
                                                            </tbody>
